...
<h4 class="d-flex justify-content-center">Знайти усiх людей, яких викрадали хоча б N разiв за вказаний перiод (з дати F по дату T)</h4>
  ...
  $n_num = " ";
      ...
      $date2 = str_replace("/",".", $date2);
        ...
        if($n_num != " ")
        {
          ...
          where (human_kidnapped_alien.kidnapping_date > '$date' and human_kidnapped_alien.kidnapping_date <'$date2')
          group by human_kidnapped_alien.human_passport, human.passport
          having count(distinct human_kidnapped_alien.kidnapping_date) >= $n_num";
        }
