...
<h4 class="d-flex justify-content-center m-4">Для прибульця A та кожної екскурсiї, яку вiн проводив, знайти скiльки разiв за вказаний
перiод (з дати F по дату T) вiн проводив екскурсiю для щонайменше N людей</h4>
  ...
  $alien = " ";
      ...
      $date2 = str_replace("/",".", $date2);
        ...
        if($alien != " ")
        {
          ...
          $sql = "SELECT count(excursion.*) as count_of_excursions_alien_held, excursion.*
          from excursion
          ...
          group by excursion_instances.excursion_id, excursion.id
          having count(excursion_instances.human_passport) >= $n_num;";
        }
