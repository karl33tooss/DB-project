...
<h4 class="d-flex justify-content-center">Для людини H знайти усiх прибульцiв, якi викрадали її хоча б N разiв за вказаний перiод
  ...
  $alien = " ";
      ...
      $date2 = str_replace("/",".", $date2);
        ...
        if($alien != " ")
        {
          ...
          group by human_kidnapped_alien.alien_isn, alien.isn 
          having count(human_kidnapped_alien.alien_isn) >= $n_num;
          ";
        }
