...
<h4 class="d-flex justify-content-center">Для людини H знайти усiх прибульцiв, яких вона вбила за вказаний перiод (з дати F по
дату T)</h4>
  ...
  $alien = " ";
      ...
      $date2 = str_replace("/",".", $date2);
        ...
        if($alien != " ")
        {
          ...
          and (human_kill_alien.killing_date > '$date' and human_kill_alien.killing_date <'$date2');";
        }
