...
<h4 class="d-flex justify-content-center">Знайти усiх прибульцiв якi викрали щонайменше N рiзних людей за вказаний перiод (з дати
F по дату T)</h4>
  ...
  $n_num = " ";
      ...
      $date2 = str_replace("/",".", $date2);
        ...
        if($n_num != " ")
        {
          ...
          having count(distinct human_kidnapped_alien.human_passport) >= $n_num;";
        }
